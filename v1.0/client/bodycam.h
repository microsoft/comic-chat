...
//	void EraseCursor(POINT &);
	...
	void RefreshBody();
	void DrawTalkTos(CAvatarX *, RECT *clientRect = NULL);
	RECT *GetTalkToRect() { return &m_talkToRect; }
	...
	void CreateRetainedPanel(CDC *pDC, HBITMAP *retSec, CDIB **retDib, int width, int height);
...
#define TALKTOHEIGHT	0	// 40		// Height & Width of TALKTO Icons
