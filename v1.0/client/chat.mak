...
# ADD LINK32 uuid3.lib winmm.lib /nologo /subsystem:windows /machine:I386 /nodefaultlib:"libc"
LINK32_FLAGS=uuid3.lib winmm.lib /nologo /subsystem:windows /incremental:no\
...
LINK32_FLAGS=uuid3.lib winmm.lib /nologo /subsystem:windows /incremental:no\
 /pdb:"$(OUTDIR)/chat.pdb" /debug /machine:I386 /nodefaultlib:"libc"\
 /out:"$(OUTDIR)/chat.exe" 
LINK32_OBJS= \
	"$(INTDIR)\admindlg.obj" \
	"$(INTDIR)\arc.obj" \
...
"$(INTDIR)\bothdlg.obj" : $(SOURCE) $(DEP_CPP_BOTHD) "$(INTDIR)"\
 "$(INTDIR)\chat.pch"
...
"$(INTDIR)\url.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\chat.pch"
