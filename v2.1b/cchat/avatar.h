...
public:
	...
	void Initialize() { m_freeze = AF_UNFROZEN; m_name = NULL; m_style = 0; m_body = NULL; m_userInfo = NULL; m_avatarID = m_origID = 0; m_flags = 0; m_nSends = 0; m_nCopies = 0; /* m_talkTo.SetSize(0,5); */ m_lastDir = FALSE; m_lastLeft = m_lastRight = 0; m_iconIndex = -1;}
	virtual ~CAvatarX();
