...
public:
	...
	~CRoomListPersist();
	void MakeEmpty();
	void Reset() { MakeEmpty(); m_cachedServer = ""; m_strUserFilter = ""; m_strTopicFilter = ""; m_bSearchDescrs = FALSE; extern CChatApp theApp; m_bRegisteredOnly = theApp.m_bListRegistered; m_minMembers = 0; m_maxMembers = 9999; m_sortAscending = TRUE; m_sortColumn = 0; m_searchTime = "";}
	void SortRooms();
