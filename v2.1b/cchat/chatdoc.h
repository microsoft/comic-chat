...
public:
	...
	CView*			m_view;
	CView*			m_client;
	CMapStringToPtr m_mapNickToPtr;
...
// Operations
public:
	void AddLine(UINT uID, const char *szText, BYTE byteMode, CDWordArray *prgdwFormatting = NULL);
	void ProcessLine(UINT uID, const char *szLine, BYTE byteMode, BYTE bbCooked, CDWordArray *prgdwFormatting = NULL);
...
protected:
	...
	static BOOL ChatLoadLocator(CArchive &f, BOOL bJoin, BOOL bException = TRUE);
