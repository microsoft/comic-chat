------------------------------------------------------------------
             Microsoft Chat SDK 2.0 Readme File
                         January 1998
------------------------------------------------------------------
...
KNOWN PROBLEMS
LOCATION OF CAB FILE FOR CHAT CONTROL 1.1
ABOUT SUPPORT
...
· Microsoft Script Chat 1.0 (script1.exe) can be used with browsers that support Java and JavaScript (or VBScript). 
...
1. Copy the binaries (chatsock.dll, mschat.ocx, nmstart.ocx, and mschatpr.ocx) to your 
   System directory. 
...
3. Create the following directories under the SDK directory that 
   ...
   Script1 (Microsoft Script Chat 1.0)
...
· Sample web pages that use Microsoft Script Chat 1.0
...
Script Chat 1.0 samples will not work with Internet Explorer 3.0 and 4.0 for
the Macintosh, since the JavaScript distributed with this version of Internet
Explorer can not poll the Java applet. 

LOCATION OF CAB FILE FOR CHAT CONTROL 1.1
==========================================
You can get the cab file for Microsoft Chat Control 1.1 
from http://activex.microsoft.com/controls/mschat/MSChatOCX.CAB.
