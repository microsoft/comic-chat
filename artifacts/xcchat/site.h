...
public:
	...
	BOOL		Create( LPUNKNOWN pObj, LPSTORAGE pStg );
	...
	IOleDocumentView  *GetDocView( void )
		{
			ATLTRACE( "CSite::GetDocView\n" );
			return( m_pIOleDocView );
		}

	IViewObject *GetViewObject( void )
		{
			ATLTRACE( "CSite::GetViewObject\n" );
    ...
    IOleObject *GetObject( void )
		{ return( m_pIOleObject ); }


	void TestServerShutdownAndClose( void );
