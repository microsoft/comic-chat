...
class UnicodeCP extends CP implements Sortable
{
  String val;
  UnicodeCP(String v)
  { val = v; }
  ...
  {
    UnicodeCP target = (UnicodeCP)t;
    return (val.compareTo(target.val) < 0);
  }
  ...
  {
    return ((arg instanceof UnicodeCP) &&
            ((UnicodeCP) arg).val.equals(val));
  }
