...
//////////////////////////////////////////////////////////////////////////////
// Window Message List Virtual Functions
//////////////////////////////////////////////////////////////////////////////

//=--------------------------------------------------------------------------=
// CWndMsgLList::bIsEqual
//=--------------------------------------------------------------------------=
...
// Notes:
//
BOOL CWndMsgLList::bIsEqual(PVOID pvCell1, PVOID pvCell2)
{
	PPRMSG pPrMsg1 = (PPRMSG) pvCell1;
	PPRMSG pPrMsg2 = (PPRMSG) pvCell2;
	...
	return (pPrMsg1->uMsg == pPrMsg2->uMsg) && 
		   (pPrMsg1->wParam == pPrMsg2->wParam) && 
		   (pPrMsg1->lParam == pPrMsg2->lParam);
}


//=--------------------------------------------------------------------------=
// CWndMsgLList::bDeleteCell
//=--------------------------------------------------------------------------=
// frees a cell
//
// Parameters:
...
// Notes:
//
BOOL CWndMsgLList::bDeleteCell(PVOID pvCell)
{
	PPRMSG	pPrMsg = (PPRMSG) pvCell;

	ASSERT(pPrMsg, "pPrMsg is NULL in CWndMsgLList::bDeleteCell");

	//#ifdef DEBUG
	//	sprintf(g_szDebugStr, "Freeing pPrMsg '%X' in CWndMsgLList::bDeleteCell\n", (INT) pvCell);
