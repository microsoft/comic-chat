...
const HRESULT	CC_E_AUTHLOOP				= CHATCLIENT_ERROR(0x0039);
//
// Channel Errors
//
...
const HRESULT	CC_E_CHANNELALREADYEXISTS	= CHATCLIENT_ERROR(0x004e);	// the channel <name> you tried to create already exists
