...
/////////////////////////////////////////////////////////////////////////////
// CLList::bRemoveCellAt - removes the cell at a given position from the linked list
BOOL CLList::bRemoveCellAt(LONG lPosition)
{
	CELL *pcellCur, *pcellPrev;

	if (m_bProtected && !m_pcs)
	{
		ASSERT(FALSE, "m_bProtected && !m_pcs in CLList::bRemoveCellAt");
		return FALSE;
	}
...
/////////////////////////////////////////////////////////////////////////////
// CLList::bRemoveCell - removes a cell from the linked list
