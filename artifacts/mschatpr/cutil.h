...
const BYTE	g_byteCTCPBrace				= 0x01;

const BYTE	g_byteChannelListingType	= 0x01;
const BYTE	g_byteChannelPropAccessType	= 0x02;
...
const UINT WM_U_UNFREEZE				= (WM_USER+13);

const UINT WM_U_MIN						= WM_U_BEGINENUMERATION;
const UINT WM_U_MAX						= WM_U_UNFREEZE;
