...
// IViewObjectEx
	...
	STDMETHOD(FreezeEvents)(BOOL bFreeze)
	{
		...
		if (!bFreeze && m_nFreezeEvents == 0 && m_hwndMess)
			::PostMessage(m_hwndMess, WM_U_UNFREEZE, 0L, 0L);
...
private:
	...
	BOOL	bDispatchMessage(UINT uMsg, WPARAM wParam, LPARAM lParam);
	...
	BOOL	bFireChannelProperty(CChatChannel* pChannel, PPRCHANNEL pPrChannel);
	...
	void	ExposeChannelItems(CChatChannel* pChannel, PPRCHANNEL pPrChannel, BOOL bFreeContent);
