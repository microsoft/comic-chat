...
public:
	...
	int DoModal();// if popup menu (e.g. context menu) was up, we need to release the mouse!  ...Override DoModal()
...
protected:
	virtual const DWORD* GetHelpIDs() = 0;
	void EnableControlRange(UINT nIDFrom, UINT nIDTo, BOOL bEnable);
...
public:
	...
	int GetPageIndexFromID(UINT nID);
